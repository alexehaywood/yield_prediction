...
| ------ | ------ | ------ | ------ | ------ | ------ |
| Generate Descriptors | Generate | Compile | Generate, compile and concatenate | Generate and compile fingerprints | Generate and compile graphs | 
| Descriptor Postprocessing | N/A |  Standardise | N/A | Calculate Tanimoto kernel | Calculate WL kernel |
