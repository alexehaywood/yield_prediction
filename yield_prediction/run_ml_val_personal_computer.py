...
def main():
    ...
    #           # {'fpSize':1024}, {'fpSize':2048}
        ...
        # info['{}_raw'.format(fp)]['X_validation'] = defaultdict()
    ...
    #     info['{}_raw'.format(fp)]['X_validation']['all_mols_train'] \
    #         = assemble_fingerprint_descriptors(
    #             rxn_components, reactions_org, rxn_smiles_org, 
    #             fp_type, fps_kw, return_raw=True, return_concat=False, return_sum=False
    #             )
    ...
    #     info['{}_raw'.format(fp)]['X_validation']['all_mols_test'] \
    #         = assemble_fingerprint_descriptors(
    #             rxn_components, reactions_val, rxn_smiles_val, 
    #             fp_type, fps_kw, return_raw=True, return_concat=False, return_sum=False
    #             )
    ...
    #     info['{}_raw'.format(fp)]['X_validation']['subset_mols_train'] \
    #         = assemble_fingerprint_descriptors(
    #             rxn_components, 
    ...
    #     info['{}_raw'.format(fp)]['X_validation']['subset_mols_test'] \
    #         = assemble_fingerprint_descriptors(
    #             rxn_components, 
